-- ✅✅✅ CORRECTED: Payment Method Videos Table
-- Uses user_roles table for admin check (NOT profiles.app_role)
...
-- CORRECT: Using user_roles table instead of profiles.app_role
