        ...
        <div className="bg-card rounded-xl p-6 card-shadow">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <Input placeholder="আপনার নাম" value={name} onChange={e => setName(e.target.value)} required />
            </div>
            <div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-4">
            ইতিমধ্যে অ্যাকাউন্ট আছে? <Link to="/login" className="text-primary font-semibold">Login</Link>
          </p>
        </div>
      </main>
      <Footer />
