      ...
      <main className="max-w-md mx-auto px-4 py-8 pb-24">
        <div className="bg-card rounded-xl p-6 card-shadow">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-foreground text-background font-bold hover:bg-foreground/90" disabled={loading}>
          ...
          <p className="text-center text-sm text-muted-foreground mt-4">
            অ্যাকাউন্ট নেই? <Link to="/register" className="text-primary font-semibold">Register</Link>
          </p>
          <p className="text-center text-sm mt-2">
            <Link to="/forgot-password" className="text-muted-foreground underline">পাসওয়ার্ড ভুলে গেছেন?</Link>
          </p>
        </div>
      </main>
      <Footer />
